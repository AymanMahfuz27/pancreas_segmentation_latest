#!/bin/bash
#SBATCH -J verify_data
#SBATCH -o verify_data.o%j
#SBATCH -e verify_data.e%j
#SBATCH -p gpu-h100
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 01:00:00
...
cat << 'EOF' > $PROJECT_DIR/verify_pancreas_data.py
import os
import torch
import numpy as np
...
mkdir -p $SCRATCH_DIR/data_verification
...
apptainer exec --nv \
    ...
    bash -c "cd /project && \
             ...
             python verify_pancreas_data.py"

echo "Data verification complete. Check outputs in $SCRATCH_DIR/data_verification/"
